...
(function(){
  ...
  const SECTIONS = [
    { id:'intro', title:'Qué es Portal Pilot', cat:'Primeros Pasos' },
    { id:'empezar', title:'Crear tu empresa', cat:'Primeros Pasos' },
    { id:'cuenta', title:'Cuenta y sesiones', cat:'Primeros Pasos' },
    { id:'ws-facturacion', title:'Facturación SAR', cat:'Workspace' },
    { id:'ws-inventario', title:'Inventario', cat:'Workspace' },
    { id:'ws-pos', title:'Punto de Venta', cat:'Workspace' },
    { id:'ws-crm', title:'CRM y cobros', cat:'Workspace' },
    { id:'ws-operacion', title:'Rutas, Flota y Sucursales', cat:'Workspace' },
    { id:'ws-reportes', title:'Reportes y transacciones', cat:'Workspace' },
    { id:'ia-uso', title:'Asistente IA', cat:'Inteligencia Artificial' },
    { id:'ia-consumo', title:'Consumo y límites IA', cat:'Inteligencia Artificial' },
    { id:'auto-intro', title:'Reglas automáticas', cat:'Automatizaciones' },
    { id:'emp-usuarios', title:'Usuarios y roles', cat:'Portal Empresa' },
    { id:'emp-suscripcion', title:'Suscripción y consumo', cat:'Portal Empresa' },
    { id:'emp-seguridad', title:'Seguridad y sesiones', cat:'Portal Empresa' },
    { id:'emp-apikeys', title:'API Keys', cat:'Portal Empresa' },
