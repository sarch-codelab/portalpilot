...
CREATE POLICY p_tenants ON tenants FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_usuarios ON usuarios; END $$;
CREATE POLICY p_usuarios ON usuarios FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_notif ON notificaciones; END $$;
CREATE POLICY p_notif ON notificaciones FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_audit_logs ON auditoria_logs; END $$;
CREATE POLICY p_audit_logs ON auditoria_logs FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_config ON configuraciones_globales; END $$;
CREATE POLICY p_config ON configuraciones_globales FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_planes ON planes_pago; END $$;
CREATE POLICY p_planes ON planes_pago FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_support ON support_tickets; END $$;
CREATE POLICY p_support ON support_tickets FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_empresas ON empresas; END $$;
CREATE POLICY p_empresas ON empresas FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_usuario_modulos ON usuario_modulos; END $$;
CREATE POLICY p_usuario_modulos ON usuario_modulos FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_tenant_features ON tenant_features; END $$;
CREATE POLICY p_tenant_features ON tenant_features FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_api_keys ON api_keys; END $$;
CREATE POLICY p_api_keys ON api_keys FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_vehiculos ON vehiculos; END $$;
CREATE POLICY p_vehiculos ON vehiculos FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_auditoria ON auditoria; END $$;
CREATE POLICY p_auditoria ON auditoria FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_auto ON automatizaciones; END $$;
CREATE POLICY p_auto ON automatizaciones FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_auto_runs ON automation_runs; END $$;
CREATE POLICY p_auto_runs ON automation_runs FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_auto_rules ON automation_rules; END $$;
CREATE POLICY p_auto_rules ON automation_rules FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_facturas ON facturas; END $$;
CREATE POLICY p_facturas ON facturas FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_trans ON transacciones; END $$;
CREATE POLICY p_trans ON transacciones FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_prod ON productos; END $$;
CREATE POLICY p_prod ON productos FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_ai_usage ON ai_usage_log; END $$;
CREATE POLICY p_ai_usage ON ai_usage_log FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_ai_scan ON ai_product_scan; END $$;
CREATE POLICY p_ai_scan ON ai_product_scan FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_cli ON clientes; END $$;
CREATE POLICY p_cli ON clientes FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_suc ON sucursales; END $$;
CREATE POLICY p_suc ON sucursales FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_bod ON bodegas; END $$;
CREATE POLICY p_bod ON bodegas FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_kardex ON kardex; END $$;
CREATE POLICY p_kardex ON kardex FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_prov ON proveedores; END $$;
CREATE POLICY p_prov ON proveedores FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_compras ON compras; END $$;
CREATE POLICY p_compras ON compras FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_compras_det ON compras_detalle; END $$;
CREATE POLICY p_compras_det ON compras_detalle FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_lista_prec ON listas_precios; END $$;
CREATE POLICY p_lista_prec ON listas_precios FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_prod_prec ON productos_precio; END $$;
CREATE POLICY p_prod_prec ON productos_precio FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_promo ON promociones; END $$;
CREATE POLICY p_promo ON promociones FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_fiadas ON ventas_fiadas; END $$;
CREATE POLICY p_fiadas ON ventas_fiadas FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_fiadas_det ON ventas_fiadas_detalle; END $$;
CREATE POLICY p_fiadas_det ON ventas_fiadas_detalle FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_abonos ON abonos; END $$;
CREATE POLICY p_abonos ON abonos FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_rutas ON rutas; END $$;
CREATE POLICY p_rutas ON rutas FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_visitas ON visitas; END $$;
CREATE POLICY p_visitas ON visitas FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_transf ON transferencias; END $$;
CREATE POLICY p_transf ON transferencias FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_transf_det ON transferencias_detalle; END $$;
CREATE POLICY p_transf_det ON transferencias_detalle FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_planes_memb ON planes_membresia; END $$;
CREATE POLICY p_planes_memb ON planes_membresia FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_socios ON socios; END $$;
CREATE POLICY p_socios ON socios FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_puntos ON puntos_historial; END $$;
CREATE POLICY p_puntos ON puntos_historial FOR ALL TO service_role USING (true);
DO $$ BEGIN DROP POLICY IF EXISTS p_renov ON renovaciones; END $$;
CREATE POLICY p_renov ON renovaciones FOR ALL TO service_role USING (true);
